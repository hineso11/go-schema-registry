...
/* UpdateSubjectLevelConfigParams contains all the parameters to send to the API endpoint
   for the update subject level config operation.
...
// WithDefaults hydrates default values in the update subject level config params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSubjectLevelConfigParams) WithDefaults() *UpdateSubjectLevelConfigParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update subject level config params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSubjectLevelConfigParams) SetDefaults() {
