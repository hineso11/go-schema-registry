...
/* GetSchemaTypesParams contains all the parameters to send to the API endpoint
   for the get schema types operation.
...
// WithDefaults hydrates default values in the get schema types params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSchemaTypesParams) WithDefaults() *GetSchemaTypesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get schema types params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSchemaTypesParams) SetDefaults() {
