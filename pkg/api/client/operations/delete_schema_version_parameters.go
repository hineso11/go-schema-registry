...
/* DeleteSchemaVersionParams contains all the parameters to send to the API endpoint
   for the delete schema version operation.
...
// WithDefaults hydrates default values in the delete schema version params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSchemaVersionParams) WithDefaults() *DeleteSchemaVersionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete schema version params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSchemaVersionParams) SetDefaults() {
