...
/* GetSubjectLevelConfigOK describes a response with status code 200, with default header values.
...
/* GetSubjectLevelConfigNotFound describes a response with status code 404, with default header values.
...
/* GetSubjectLevelConfigInternalServerError describes a response with status code 500, with default header values.
