...
// WithDefaults hydrates default values in the update mode params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateModeParams) WithDefaults() *UpdateModeParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update mode params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateModeParams) SetDefaults() {
