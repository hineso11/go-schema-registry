...
/* DeleteSchemaVersionOK describes a response with status code 200, with default header values.
...
/* DeleteSchemaVersionNotFound describes a response with status code 404, with default header values.
...
/* DeleteSchemaVersionUnprocessableEntity describes a response with status code 422, with default header values.
...
/* DeleteSchemaVersionInternalServerError describes a response with status code 500, with default header values.
