...
/* GetSchemaByVersionParams contains all the parameters to send to the API endpoint
   for the get schema by version operation.
...
// WithDefaults hydrates default values in the get schema by version params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSchemaByVersionParams) WithDefaults() *GetSchemaByVersionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get schema by version params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSchemaByVersionParams) SetDefaults() {
