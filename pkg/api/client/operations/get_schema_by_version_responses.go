...
/* GetSchemaByVersionOK describes a response with status code 200, with default header values.
...
/* GetSchemaByVersionNotFound describes a response with status code 404, with default header values.
...
/* GetSchemaByVersionUnprocessableEntity describes a response with status code 422, with default header values.
...
/* GetSchemaByVersionInternalServerError describes a response with status code 500, with default header values.
