...
/* TestCompatibilityBySubjectNameOK describes a response with status code 200, with default header values.
...
/* TestCompatibilityBySubjectNameNotFound describes a response with status code 404, with default header values.
...
/* TestCompatibilityBySubjectNameUnprocessableEntity describes a response with status code 422, with default header values.
...
/* TestCompatibilityBySubjectNameInternalServerError describes a response with status code 500, with default header values.
