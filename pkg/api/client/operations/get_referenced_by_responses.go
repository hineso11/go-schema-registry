...
/* GetReferencedByOK describes a response with status code 200, with default header values.
...
/* GetReferencedByNotFound describes a response with status code 404, with default header values.
...
/* GetReferencedByUnprocessableEntity describes a response with status code 422, with default header values.
...
/* GetReferencedByInternalServerError describes a response with status code 500, with default header values.
