...
/* GetSchemaOnlyParams contains all the parameters to send to the API endpoint
   for the get schema only operation.
...
// WithDefaults hydrates default values in the get schema only params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSchemaOnlyParams) WithDefaults() *GetSchemaOnlyParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get schema only params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSchemaOnlyParams) SetDefaults() {
