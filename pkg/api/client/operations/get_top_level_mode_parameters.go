...
/* GetTopLevelModeParams contains all the parameters to send to the API endpoint
   for the get top level mode operation.
...
// WithDefaults hydrates default values in the get top level mode params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTopLevelModeParams) WithDefaults() *GetTopLevelModeParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get top level mode params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTopLevelModeParams) SetDefaults() {
