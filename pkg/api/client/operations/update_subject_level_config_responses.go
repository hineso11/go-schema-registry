...
/* UpdateSubjectLevelConfigOK describes a response with status code 200, with default header values.
...
/* UpdateSubjectLevelConfigUnprocessableEntity describes a response with status code 422, with default header values.
...
/* UpdateSubjectLevelConfigInternalServerError describes a response with status code 500, with default header values.
