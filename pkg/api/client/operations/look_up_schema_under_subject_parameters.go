...
/* LookUpSchemaUnderSubjectParams contains all the parameters to send to the API endpoint
   for the look up schema under subject operation.
...
// WithDefaults hydrates default values in the look up schema under subject params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LookUpSchemaUnderSubjectParams) WithDefaults() *LookUpSchemaUnderSubjectParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the look up schema under subject params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LookUpSchemaUnderSubjectParams) SetDefaults() {
