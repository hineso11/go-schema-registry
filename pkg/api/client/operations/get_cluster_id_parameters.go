...
/* GetClusterIDParams contains all the parameters to send to the API endpoint
   for the get cluster Id operation.
...
// WithDefaults hydrates default values in the get cluster Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterIDParams) WithDefaults() *GetClusterIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get cluster Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterIDParams) SetDefaults() {
