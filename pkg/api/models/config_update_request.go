...
// ContextValidate validates this config update request based on context it is used
func (m *ConfigUpdateRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
