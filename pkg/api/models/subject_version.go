...
// ContextValidate validates this subject version based on context it is used
func (m *SubjectVersion) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
